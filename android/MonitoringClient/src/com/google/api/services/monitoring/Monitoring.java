...
public class Monitoring extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://localhost:8888/_ah/api/";
   ...
   * @return the request
   */
  public Arm arm() throws java.io.IOException {
    Arm result = new Arm();
    initialize(result);
    return result;
  }

  public class Arm extends MonitoringRequest<Void> {

    private static final String REST_PATH = "arm";
